...
async def add_ranking(interaction: discord.Interaction, profile_id: typing.Optional[str], name: typing.Optional[str], discord_id: typing.Optional[str]):
    log("Comando add_ranking")
    if interaction.user.id == 474968187637596160 or interaction.user.id == 401762141906141184 or interaction.user.id == 292314272640401409 or interaction.user.id == 618398991700459520:
        ...
        if profile_id != None and name != None and discord_id != None:
